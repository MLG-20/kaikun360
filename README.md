...
- [~] Écran **Paiements** (acomptes, soldes, commissions, statuts, remboursements, export comptable). ✅ commissions (colonne + total de période), statuts, remboursements (F7.2.d) et **export comptable** (F7.3.d). ❌ **Acomptes / soldes** : la table `payments` autorise bien plusieurs règlements par réservation — sa migration cite « acompte, solde » — mais aucun champ ne les distingue et rien ne calcule un reste à payer ; dernier trou du module, côté **backend**. — _F7.2.d + F7.3.d._
