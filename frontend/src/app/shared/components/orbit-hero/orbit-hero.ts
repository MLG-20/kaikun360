...
interface OrbitUniverse {
  ...
  price: string;
  cta: string;
  /** Page de destination réelle (le nœud et le CTA central y mènent). */
  link: string;
  icon: string[];
}
...
export class OrbitHeroComponent {
  private readonly universes: OrbitUniverse[] = [
    { title: 'Immobilier', price: 'dès 150 000 F / mois', cta: 'Voir les biens', link: '/immobilier', icon: ['M3 10.5 12 3l9 7.5', 'M5 9.5V21h14V9.5', 'M10 21v-6h4v6'] },
    { title: 'Nuitées', price: 'dès 25 000 F / nuit', cta: 'Réserver un séjour', link: '/nuitees', icon: ['M3 8v10', 'M3 18h18v-2a4 4 0 0 0-4-4H3', 'M7 12V9h5v3'] },
    { title: 'Construction', price: 'dès 180 000 F / m²', cta: 'Simuler un chantier', link: '/construction', icon: ['M14.7 6.3a4 4 0 0 0-5.4 5.4L3 18l3 3 6.3-6.3a4 4 0 0 0 5.4-5.4l-2.3 2.3-2-2z'] },
    { title: 'Transport', price: 'dès 20 000 F / trajet', cta: 'Réserver un trajet', link: '/transport', icon: ['M3 13V7h11l4 4v2', 'M2 13h18v4H2z', 'M7 17a1.5 1.5 0 1 0 0 .01', 'M16 17a1.5 1.5 0 1 0 0 .01'] },
    { title: 'Tourisme', price: 'dès 30 000 F / jour', cta: 'Créer un circuit', link: '/tourisme', icon: ['M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18z', 'M15.5 8.5l-2.2 4.8-4.8 2.2 2.2-4.8z'] },
