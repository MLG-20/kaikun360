...
- **165 endpoints** REST versionnés (`/api/v1`) — voir [`API.md`](API.md)
- **11 modules** métier isolés
- **55 tables**, référentiel géographique du Sénégal inclus
- **479 tests** automatisés (1387 assertions), tous verts ✅
...
notifications) et **vérifié par 479 tests automatiques** — des petits programmes
...
├── API.md               # Référence des 165 endpoints
...
```bash
php artisan test
# 479 tests, 1387 assertions — verts
```
...
| Document | Contenu |
| --- | --- |
| [`API.md`](API.md) | Référence des 165 endpoints (accès, contrôleurs) |
